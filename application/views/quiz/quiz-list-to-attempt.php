								...
								if ($quizList) {
									...
									foreach ($quizList as $quiz) { ?>
										...
										<tr class="even pointer">
											...
											<td class=" "><a href="<?php echo base_url(); ?>current-attempted-quiz/<?php echo md5($quiz['quiz_id']); ?>" title="View Options" onclick="showQuizDetails(<?php echo $quiz['quiz_id']; ?>)" style="color: blue;"><?php echo $quiz['quiz_name']; ?></a></td>
