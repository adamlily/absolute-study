...
/***** Master Route*****/
$route['admin/course-list'] 	= 'master/courseList';
$route['admin/add-course'] 			= 'master/addNewCourse';
$route['admin/subject-list'] 	= 'master/subjectList';
$route['admin/add-subject'] 			= 'master/addNewSubject';
$route['admin/topic-list'] 		= 'master/topicList';
$route['admin/add-topic'] 			= 'master/addNewTopic';
...
/***** AJAX Request Routes *****/
$route['get-subject-list-by-course'] 			= 'ajax/getSubjectListByCourseId';
$route['get-subject-list-by-course-subject'] 	= 'ajax/getTopicListByCourseAndSubjectId';
