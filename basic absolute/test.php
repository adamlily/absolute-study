...
require_once("class/class.startquiz.php");
extract($_REQUEST);
$auth = new Authentication();
$notice = new Notification();
$home =  new Homepage();
$start_new_quiz= new Take_Quiz();
$ajax=new PHPLiveX();
$ajax->AjaxifyObjects(array("start_new_quiz"));
?>
<!DOCTYPE html>
...
<body class="t-peachy t-pattern-2 kids-front-page t-menu-1 t-header-1 t-text-1">
	<div id="pr" style="visibility:hidden; z-index:50000px; background: none repeat scroll 0 0 #000000;
    left: 0; position: absolute; top: 0; height: 1207px; opacity: 0.4; width: 1349px; z-index: 9500; vertical-align:middle" align="center"><img src="images/loading2.gif" width="200" height="200"></div> 
	<div class="top-panel">
			...
			<div class="bg-level-2-page-width-container l-page-width no-padding">
				...
				<section class="kids_bottom_content_container">
					...
					<div class="entry-container">
						...
						<?php $start_new_quiz->takequiz($student_id,$quizId);?>
						</div><!--/ .l-grid-9-->
						...
						<h1>Your Answers</h1>
							...
							<div class="map-substrate">
										...
										<?php  $start_new_quiz->attempted_ques($quizId);?>
